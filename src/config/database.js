  ...
  await Plan.bulkCreate([
    {
      name: 'Starter',
      slug: 'starter',
      description: 'For small businesses getting started with AI calling — 100 minutes included',
      price: 2499,
    ...
    },
    {
      name: 'Professional',
      slug: 'professional',
      description: 'For growing businesses scaling outbound calling — 400 minutes included',
      price: 6999,
      billingCycle: 'monthly',
      creditMinutes: 400,
      maxWorkflows: 5,
    ...
    },
    {
      name: 'Business',
      slug: 'business',
      description: 'High-volume calling for mid-size enterprises — 1,000 minutes included',
      price: 14999,
      billingCycle: 'monthly',
      creditMinutes: 1000,
      maxWorkflows: 15,
    ...
    },
    {
      name: 'Enterprise',
      slug: 'enterprise',
      description: 'Full-scale deployment for large organisations — 2,500 minutes included',
      price: 29999,
      billingCycle: 'monthly',
      creditMinutes: 2500,
      maxWorkflows: 50,
