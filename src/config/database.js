  ...
  await Plan.bulkCreate([
    {
      name: 'Starter',
      slug: 'starter',
      description: 'Get started with AI calling — 120 minutes included',
      price: 999,
    ...
    },
    {
      name: 'Growth',
      slug: 'growth',
      description: 'Scale your outbound calling — 500 minutes included',
      price: 2999,
      billingCycle: 'monthly',
      creditMinutes: 500,
      maxWorkflows: 5,
    ...
    },
    {
      name: 'Business',
      slug: 'business',
      description: 'High-volume AI calling for teams — 1,500 minutes included',
      price: 7999,
      billingCycle: 'monthly',
      creditMinutes: 1500,
      maxWorkflows: 15,
    ...
    },
    {
      name: 'Enterprise',
      slug: 'enterprise',
      description: 'Unlimited power for large organisations — 5,000 minutes included',
      price: 19999,
      billingCycle: 'monthly',
      creditMinutes: 5000,
      maxWorkflows: -1,
